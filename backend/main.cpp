...
cout << "\nEnter Date Of Journey in the given for at (DDMMYY)." << "Please enter a valid date."
      << endl;
    
cin >> doj;
    
cout <<
      "\t1.Delhi   2.Pune   3.Mumbai   4.Banglore" <<
      endl << endl;
...
void
createfile (passenger p)	                                       //file creation for domestic booking
{
...
void
cancelticket (int x)		                                        //function to cancel ticket
{
  passenger p;
...
void
checkticket (int x)		                        //function to check PNR or ticket
{
  passenger p;
...
void
createfilei (passenger p)	                                        //opening a file for international booking
{
...
void
cancelticketi (int x)		                                        //function to cancel ticket
{
  passenger p;
...
void
checkticketi (int x)		//to check PNR or ticket
{
  passenger p;
